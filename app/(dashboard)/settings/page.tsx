...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Hub — Team Settings (this page) + Blog Management (→ /blogs) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div className="w-11 h-11 bg-blue-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm shadow-blue-200">
        ...
        >
          <div className="w-11 h-11 bg-indigo-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm shadow-indigo-200">
