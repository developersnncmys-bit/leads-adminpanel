...
export default function NotificationsModal({ notifications, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed top-[100px] right-4 sm:right-5 z-50 w-[calc(100vw-32px)] sm:w-96 bg-white rounded-2xl border border-gray-100 shadow-2xl flex flex-col max-h-[calc(100vh-120px)] overflow-hidden">
